...
final class ViewPagerPageScrollStateChangeOnSubscribe implements Observable.OnSubscribe<Integer> {

    private final ViewPager view;

    ViewPagerPageScrollStateChangeOnSubscribe(ViewPager view) {
        this.view = view;
    }
